            ...
            <div class="row full-width justify-center container">
              ...
              <div :class="$q.screen.lt.md ? 'order-first custom-rounded-borders-top' : 'card custom-rounded-borders'"
                ...
                <div class="relative-position profile-image-size">
                  ...
                  <q-img
                    v-else
                    alt="profile picture of Mahshid"
                    class="custom-rounded-borders-top fit profile-image profile-image-size"
                    fit="cover"
                    src="~assets/images/test1.jpg"
                  />
...
const SocialMediaItems = [
  {
    name: 'email',
    link: 'mailto:mahshid2ghaffari@gmail.com',
    icon: 'mdi-gmail',
    target: '_self',
    hover: 'mahshid2ghaffari@gmail.com',
  },
  {
    name: 'phone',
    link: 'tel:+31687153781',
    icon: 'mdi-phone',
    target: '_self',
    hover: '+31687153781',
  },
  {
    name: 'Linkedin',
    link: 'https://www.linkedin.com/in/mahshid-ghaffari-838949b7/',
    icon: 'mdi-linkedin',
    target: '_blank',
  },
  // {
  ...
  {
    name: 'Github',
    link: 'https://github.com/mahshidghaffari',
    icon: 'mdi-github',
    target: '_blank',
  },
]
